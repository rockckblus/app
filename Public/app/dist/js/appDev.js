...
document.write('<script src="' + basePath + '/src/js/directive/member/myKill.dipan.myKill.directive.js"><\/script>');
document.write('<script src="' + basePath + '/src/js/directive/member/myNeed.dipan.myNeed.directive.js"><\/script>');
