...
var Zepto = function () {
    ...
    function b(a) {
        return "children" in a ? y.call(a.children) : q.map(a.childNodes, function (a) {
    ...
    function g(a, c) {
        var e = a.className || "", b = e && e.baseVal !== E;
    ...
    function H(a, c) {
        c(a);
        for (var e = 0, b = a.childNodes.length; e < b; e++)H(a.childNodes[e], c)
    }

    var E, B, q, F, G = [], y = G.slice, a = G.filter, c = window.document, e = {}, k = {}, z = {
            "column-count": 1, columns: 1, "font-weight": 1,
            "line-height": 1, opacity: 1, "z-index": 1, zoom: 1
        }, M = /^\s*<(\w+|!)[^>]*>/, T = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, U = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, O = /^(?:body|html)$/i, V = /([A-Z])/g, W = "val css html text data width height offset".split(" "), N = c.createElement("table"), P = c.createElement("tr"), Q = {
            ...
            th: P,
            "*": c.createElement("div")
        }, X = /complete|loaded|interactive/, Y = /^[\w-]*$/, L = {}, S = L.toString, D = {}, J, K, R = c.createElement("div"),
        Z = {
            tabindex: "tabIndex",
            readonly: "readOnly",
            "for": "htmlFor",
    ...
    D.fragment = function (a, e, b) {
        ...
        k || (a.replace && (a = a.replace(U, "<$1></$2>")), e === E && (e = M.test(a) && RegExp.$1), e in Q || (e = "*"), f = Q[e], f.innerHTML = "" + a, k = q.each(y.call(f.childNodes), function () {
            f.removeChild(this)
        }));
        p(b) && (z = q(k), q.each(b, function (a, c) {
            if (-1 < W.indexOf(a))z[a](c); else z.attr(a, c)
        }));
        return k
    };
    D.Z = function (a, c) {
    ...
    D.init = function (a, e) {
        var b;
        if (a)if ("string" == typeof a)if (a = a.trim(), "<" == a[0] && M.test(a))b = D.fragment(a, RegExp.$1, e), a = null; else {
            if (e !== E)return q(e).find(a);
            b = D.qsa(c, a)
        } else {
            if (t(a))return q(c).ready(a);
            if (D.isZ(a))return a;
            if (I(a))b = u(a); else if (w(a))b = [a], a = null; else if (M.test(a))b = D.fragment(a.trim(),
                RegExp.$1, e), a = null; else {
                if (e !== E)return q(e).find(a);
                b = D.qsa(c, a)
            }
        } else return D.Z();
    ...
    D.qsa = function (a, c) {
        var e, b = "#" == c[0], k = !b && "." == c[0], z = b || k ? c.slice(1) : c, f = Y.test(z);
        return r(a) && f && b ? (e = a.getElementById(z)) ? [e] : [] : 1 !== a.nodeType && 9 !== a.nodeType ? [] : y.call(f && !b ? k ? a.getElementsByClassName(z) : a.getElementsByTagName(c) :
            a.querySelectorAll(c))
    };
    q.contains = c.documentElement.contains ? function (a, c) {
    ...
    q.map = function (a, c) {
        var e, b = [],
            k;
        if (m(a))for (k = 0; k < a.length; k++)e = c(a[k], k), null != e && b.push(e); else for (k in a)e = c(a[k], k), null != e && b.push(e);
        return 0 < b.length ? q.fn.concat.apply([], b) : b
    };
    q.each = function (a, c) {
        var e;
        if (m(a))for (e = 0; e < a.length && !1 !== c.call(a[e], e, a[e]); e++); else for (e in a)if (!1 === c.call(a[e], e, a[e]))break;
        return a
    };
    q.grep = function (c, e) {
        return a.call(c, e)
    ...
    q.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function (a, c) {
    ...
    q.fn = {
        ...
        concat: G.concat,
        map: function (a) {
            return q(q.map(this, function (c, e) {
                return a.call(c, e, c)
            }))
        },
        slice: function () {
        ...
        ready: function (a) {
            X.test(c.readyState) && c.body ? a(q) : c.addEventListener("DOMContentLoaded", function () {
                a(q)
            }, !1);
            return this
        },
        ...
        each: function (a) {
            G.every.call(this, function (c, e) {
                return !1 !== a.call(c, e, c)
            });
            return this
        },
        filter: function (c) {
            return t(c) ? this.not(this.not(c)) : q(a.call(this, function (a) {
        ...
        not: function (a) {
            ...
            if (t(a) && a.call !== E)this.each(function (e) {
                ...
                var e = "string" == typeof a ? this.filter(a) :
                    m(a) && t(a.item) ? y.call(a) : q(a);
        ...
        find: function (a) {
            ...
            return a ? "object" == typeof a ? q(a).filter(function () {
                var a = this;
                return G.some.call(c, function (c) {
                    return q.contains(c,
                        a)
                })
        ...
        parents: function (a) {
            for (var c = [], e = this; 0 < e.length;)e = q.map(e, function (a) {
                if ((a = a.parentNode) && !r(a) && 0 > c.indexOf(a))return c.push(a), a
            });
            return h(c, a)
        },
        parent: function (a) {
        ...
        siblings: function (c) {
            return h(this.map(function (c, e) {
                return a.call(b(e.parentNode), function (a) {
                    return a !== e
                })
            }), c)
        },
        ...
        wrap: function (a) {
            var c = t(a);
            if (this[0] && !c)var e = q(a).get(0), b = e.parentNode || 1 < this.length;
        ...
        toggle: function (a) {
            return this.each(function () {
                var c = q(this);
                (a === E ? "none" == c.css("display") : a) ? c.show() : c.hide()
            })
        },
        prev: function (a) {
        ...
        attr: function (a, c) {
            ...
            return "string" != typeof a || 1 in arguments ? this.each(function (e) {
                ...
                } else b = a, e = f(this, c, e, this.getAttribute(a)), null == e ? this.removeAttribute(b) : this.setAttribute(b, e)
        ...
        data: function (a, c) {
            var e = "data-" + a.replace(V, "-$1").toLowerCase(), e = 1 in arguments ? this.attr(e, c) : this.attr(e);
            return null !== e ? x(e) : E
        },
        val: function (a) {
            return 0 in arguments ? this.each(function (c) {
        ...
        offset: function (a) {
            if (a)return this.each(function (c) {
                ...
                c = {top: c.top - b.top, left: c.left - b.left};
        ...
        toggleClass: function (a,
            ...
            return a ? this.each(function (e) {
                var b = q(this);
                f(this, a, e, g(this)).split(/\s+/g).forEach(function (a) {
                    (c === E ? !b.hasClass(a) : c) ? b.addClass(a) : b.removeClass(a)
                })
            }) : this
        },
        scrollTop: function (a) {
            if (this.length) {
                ...
                return a === E ? c ? this[0].scrollTop : this[0].pageYOffset : this.each(c ? function () {
                    this.scrollTop = a
                } : function () {
        ...
        position: function () {
            if (this.length) {
                var a = this[0], c = this.offsetParent(), e = this.offset(), b = O.test(c[0].nodeName) ? {
                    top: 0,
                    left: 0
                } : c.offset();
        ...
        offsetParent: function () {
            return this.map(function () {
                for (var a =
                    this.offsetParent || c.body; a && !O.test(a.nodeName) && "static" == q(a).css("position");)a = a.offsetParent;
                return a
            })
        }
    };
    ...
    ["after", "prepend", "before", "append"].forEach(function (a, e) {
        ...
        q.fn[a] =
            function () {
                var a, k = q.map(arguments, function (c) {
                    a = d(c);
                ...
                return 1 > k.length ? this : this.each(function (a, f) {
                    ...
                    k.forEach(function (a) {
                        if (z)a = a.cloneNode(!0); else if (!y)return q(a).remove();
                        y.insertBefore(a, f);
                        g && H(a, function (a) {
...
(function (d) {
        ...
        a.split(/\s/).forEach(function (a) {
            ...
            f.proxy = function (a) {
                ...
                if (!a.isImmediatePropagationStopped()) {
                    a.data = e;
                    var c = h.apply(b, a._args == A ? [a] : [a].concat(a._args));
    ...
    function u(b, a) {
        if (a || !b.isDefaultPrevented)if (a || (a = b), d.each(G, function (c, e) {
                var k = a[c];
                b[c] = function () {
                    this[e] = B;
                ...
                b[e] = q
            }), a.defaultPrevented !== A ? a.defaultPrevented : "returnValue" in a ? !1 === a.returnValue : a.getPreventDefault && a.getPreventDefault())b.isDefaultPrevented =
            B;
        return b
    }

    function v(b) {
        var a, c = {originalEvent: b};
        for (a in b)F.test(a) || b[a] === A || (c[a] = b[a]);
        return u(c, b)
    }

    var C = 1, A, b = Array.prototype.slice, l = d.isFunction, h = function (b) {
        return "string" == typeof b
    }, f = {}, g = {}, x = "onfocusin" in window, H = {
        focus: "focusin",
        blur: "focusout"
    }, E = {mouseenter: "mouseover", mouseleave: "mouseout"};
    g.click = g.mousedown = g.mouseup = g.mousemove = "MouseEvents";
    d.event = {add: p, remove: m};
    d.proxy = function (y, a) {
        var c = 2 in arguments && b.call(arguments, 2);
        if (l(y)) {
            var e = function () {
                return y.apply(a,
                    c ? c.concat(b.call(arguments)) : arguments)
            };
            e._zid = t(y);
            return e
        }
    ...
    d.fn.on = function (y, a, c, e, k) {
        var z, f, g = this;
        if (y && !h(y))return d.each(y, function (e, b) {
            g.on(e, a, c, b, k)
        }), g;
    ...
    d.fn.off = function (b, a, c) {
        var e = this;
        if (b && !h(b))return d.each(b, function (c, b) {
            e.off(c, a, b)
        }), e;
        h(a) || l(c) || !1 === c || (c = a, a = A);
        !1 === c && (c = q);
    ...
    d.fn.trigger = function (b, a) {
        b = h(b) || d.isPlainObject(b) ? d.Event(b) :
            u(b);
        b._args = a;
        return this.each(function () {
            if (b.type in H && "function" == typeof this[b.type])this[b.type](); else"dispatchEvent" in this ? this.dispatchEvent(b) : d(this).triggerHandler(b, a)
        })
    };
    d.fn.triggerHandler = function (b, a) {
        ...
        this.each(function (k, z) {
            ...
            c._args = a;
            c.target = z;
            d.each(n(z, b.type || b), function (a, b) {
                e = b.proxy(c);
    ...
    d.Event = function (b, a) {
        h(b) || (a = b, b = a.type);
        var c = document.createEvent(g[b] || "Events"), e = !0;
...
(function (d) {
    function t(b, a, c, e) {
        if (b.global)return b = a || f, c = d.Event(c), d(b).trigger(c, e), !c.isDefaultPrevented()
    }
    ...
    function A(b) {
        b.processData && b.data && "string" != d.type(b.data) && (b.data = d.param(b.data,
            b.traditional));
        !b.data || b.type && "GET" != b.type.toUpperCase() || (b.url = C(b.url, b.data), b.data = void 0)
    }

    function b(b, a, c, e) {
        d.isFunction(a) && (e = c, c = a, a = void 0);
        d.isFunction(c) || (e = c, c = void 0);
        return {url: b, data: a, success: c, dataType: e}
    }

    function l(b, a, c, e) {
        var k, z = d.isArray(a), f = d.isPlainObject(a);
        d.each(a, function (a, g) {
            k = d.type(g);
            e && (a = c ? e : e + "[" + (f || "object" == k || "array" == k ? a : "") + "]");
            !e && z ? b.add(g.name, g.value) : "array" == k || !c && "object" == k ? l(b, g, c, a) : b.add(a, g)
        })
    }

    var h = 0, f = window.document, g, x, H = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,
        E = /^(?:text|application)\/javascript/i, B = /^(?:text|application)\/xml/i, q = /^\s*$/, F = f.createElement("a");
    F.href = window.location.href;
    d.active = 0;
    d.ajaxJSONP = function (b, a) {
        if (!("type" in b))return d.ajax(b);
        var c = b.jsonpCallback, e = (d.isFunction(c) ? c() : c) || "jsonp" + ++h, k = f.createElement("script"), z = window[e], g, l = function (a) {
            d(k).triggerHandler("error", a || "abort")
        }, x = {abort: l}, m;
        a && a.promise(x);
        d(k).on("load error", function (c, f) {
            clearTimeout(m);
            d(k).off().remove();
            "error" != c.type && g ? w(g[0], x, b, a) : p(null,
                f || "error", x, b, a);
            window[e] = z;
            g && d.isFunction(z) && z(g[0]);
            z = g = void 0
        });
        if (!1 === r(x, b))return l("abort"), x;
        window[e] = function () {
            g = arguments
        };
    ...
    d.ajaxSettings = {
        type: "GET", beforeSend: u, success: u, error: u, complete: u, context: null, global: !0, xhr: function () {
            return new window.XMLHttpRequest
        }, accepts: {
            script: "text/javascript, application/javascript, application/x-javascript",
            json: "application/json", xml: "application/xml, text/xml", html: "text/html", text: "text/plain"
        }, crossDomain: !1, timeout: 0, processData: !0, cache: !0
    };
    d.ajax = function (b) {
        var a = d.extend({}, b || {}), c = d.Deferred && d.Deferred(), e;
        ...
        (e = /\?.+=\?/.test(a.url)) &&
        (k = "jsonp");
        !1 !== a.cache && (b && !0 === b.cache || "script" != k && "jsonp" != k) || (a.url = C(a.url, "_=" + Date.now()));
        if ("jsonp" == k)return e || (a.url = C(a.url, a.jsonp ? a.jsonp + "=?" : !1 === a.jsonp ? "" : "callback=?")), d.ajaxJSONP(a, c);
        b = a.accepts[k];
        var z = {};
        e = function (a, c) {
            z[a.toLowerCase()] = [a, c]
        };
        var h = /^([\w-]+:)\/\//.test(a.url) ? RegExp.$1 : window.location.protocol, l = a.xhr(), m = l.setRequestHeader, t;
        c && c.promise(l);
        a.crossDomain || e("X-Requested-With", "XMLHttpRequest");
        e("Accept", b || "*/*");
        if (b = a.mimeType || b)-1 < b.indexOf(",") &&
        (b = b.split(",", 2)[0]), l.overrideMimeType && l.overrideMimeType(b);
        (a.contentType || !1 !== a.contentType && a.data && "GET" != a.type.toUpperCase()) && e("Content-Type", a.contentType || "application/x-www-form-urlencoded");
        ...
        if (!1 === r(l, a))return l.abort(), p(null, "abort", l, a, c), l;
    ...
    d.fn.load = function (f, a, c) {
        ...
        var e = this, k = f.split(/\s/), z;
        f = b(f, a, c);
        var l = f.success;
        1 < k.length && (f.url = k[0], z = k[1]);
        f.success = function (a) {
            e.html(z ? d("<div>").html(a.replace(H, "")).find(z) :
                a);
...
(function (d) {
    d.fn.serializeArray = function () {
        var t, n, r = [], w = function (d) {
            if (d.forEach)return d.forEach(w);
            r.push({name: t, value: d})
        };
        this[0] && d.each(this[0].elements, function (p, m) {
            n = m.type;
            (t = m.name) && "fieldset" != m.nodeName.toLowerCase() && !m.disabled && "submit" != n && "reset" != n && "button" != n && "file" != n && ("radio" != n && "checkbox" != n || m.checked) && w(d(m).val())
        });
        return r
    };
...
define("lib/z", [], function (d, t, n) {
    n.exports = window.Zepto
});
(function () {
    var d = this, t = d._, n = Array.prototype, r = Object.prototype, w = n.push, p = n.slice, m = n.concat, u = r.toString, v = r.hasOwnProperty, r = Array.isArray, C = Object.keys, A = Function.prototype.bind, b = function (a) {
    ...
    b.each = b.forEach = function (a, c, e) {
        ...
        c = l(c, e);
        var k = a.length;
        if (k === +k)for (e = 0; e < k; e++)c(a[e], e, a); else {
            var f = b.keys(a);
            e = 0;
            for (k = f.length; e < k; e++)c(a[f[e]],
                f[e], a)
        }
        return a
    };
    b.map = b.collect = function (a, c, e) {
        ...
        for (var k = (e || a).length, f = Array(k), l, g = 0; g < k; g++)l = e ? e[g] : g, f[g] = c(a[l], l, a);
        return f
    };
    b.reduce = b.foldl = b.inject = function (a, c, e, k) {
        null == a && (a = []);
        c = l(c, k, 4);
        var f = a.length !== +a.length && b.keys(a), g = (f || a).length, h = 0, x;
        if (3 > arguments.length) {
            if (!g)throw new TypeError("Reduce of empty array with no initial value");
            e = a[f ? f[h++] : h++]
        }
        for (; h < g; h++)x = f ? f[h] : h, e = c(e, a[x], x, a);
        return e
    };
    b.reduceRight = b.foldr = function (a, c, e, k) {
        null == a && (a = []);
        c = l(c, k, 4);
        var f = a.length !== +a.length && b.keys(a), g = (f || a).length, h;
        if (3 > arguments.length) {
            if (!g)throw new TypeError("Reduce of empty array with no initial value");
            e = a[f ? f[--g] : --g]
        }
        for (; g--;)h = f ? f[g] : g, e = c(e, a[h], h, a);
        return e
    };
    b.find = b.detect = function (a, c, e) {
        var k;
        c = b.iteratee(c, e);
        b.some(a, function (a, b, e) {
            if (c(a, b, e))return k = a, !0
        });
        return k
    };
    ...
    b.invoke = function (a, c) {
        var e = p.call(arguments, 2), k = b.isFunction(c);
    ...
    b.max = function (a, c, e) {
        var k = -Infinity, f = -Infinity, g;
        if (null == c && null != a) {
            a = a.length === +a.length ? a : b.values(a);
            for (var l =
                0, h = a.length; l < h; l++)e = a[l], e > k && (k = e)
        } else c = b.iteratee(c, e), b.each(a, function (a, b, e) {
            g = c(a, b, e);
            if (g > f || -Infinity === g && -Infinity === k)k = a, f = g
        });
        return k
    };
    b.min = function (a, c, e) {
        ...
        if (null == c && null != a) {
            a = a.length === +a.length ? a : b.values(a);
            for (var l = 0, h = a.length; l < h; l++)e = a[l], e < k && (k = e)
        } else c = b.iteratee(c, e), b.each(a, function (a, b, e) {
            g = c(a, b, e);
            if (g < f || Infinity === g && Infinity === k)k = a, f = g
        });
    ...
    b.shuffle = function (a) {
        ...
        for (var c = a.length,
                 e = Array(c), k = 0, f; k < c; k++)f = b.random(0, k), f !== k && (e[k] = e[f]), e[f] = a[k];
        return e
    };
    ...
    b.sortBy = function (a, c, e) {
        ...
        return b.pluck(b.map(a, function (a, b, e) {
            return {value: a, index: b, criteria: c(a, b, e)}
        }).sort(function (a, c) {
    ...
    b.toArray = function (a) {
        return a ? b.isArray(a) ? p.call(a) : a.length === +a.length ? b.map(a, b.identity) :
            b.values(a) : []
    };
    b.size = function (a) {
    ...
    b.last = function (a, c, b) {
        return null == a ? void 0 : null == c || b ? a[a.length - 1] : p.call(a, Math.max(a.length -
            c, 0))
    };
    ...
    b.uniq = b.unique = function (a, c, e, k) {
        ...
        for (var f = [], g = 0, l = a.length; g < l; g++) {
            var h = a[g];
            if (c)g && f === h || k.push(h), f = h; else if (e) {
                var x = e(h, g, a);
    ...
    b.object = function (a, c) {
        if (null == a)return {};
        for (var b = {}, k = 0, f = a.length; k < f; k++)c ? b[a[k]] = c[k] : b[a[k][0]] = a[k][1];
        return b
    };
    b.indexOf = function (a, c, e) {
        if (null == a)return -1;
        var k = 0, f = a.length;
        if (e)if ("number" == typeof e)k = 0 > e ? Math.max(0, f + e) : e; else return k =
            b.sortedIndex(a, c), a[k] === c ? k : -1;
    ...
    b.partial = function (a) {
        ...
        return function () {
            for (var e = 0, f = c.slice(), g = 0, l = f.length; g < l; g++)f[g] === b && (f[g] = arguments[e++]);
    ...
    b.bindAll = function (a) {
        ...
        for (c = 1; c < e; c++)f = arguments[c], a[f] = b.bind(a[f], a);
        return a
    };
    b.memoize = function (a, c) {
        var e = function (f) {
            var g = e.cache, l = c ? c.apply(this, arguments) : f;
    ...
    b.compose = function () {
        var a = arguments, c = a.length - 1;
        return function () {
            for (var b = c, f = a[c].apply(this, arguments); b--;)f = a[b].call(this, f);
            return f
        }
    };
    ...
    b.invert = function (a) {
        for (var c = {}, e = b.keys(a), f = 0, g = e.length; f < g; f++)c[a[e[f]]] = e[f];
        return c
    };
    b.functions = b.methods = function (a) {
        var c = [], e;
        for (e in a)b.isFunction(a[e]) &&
        c.push(e);
        return c.sort()
    };
    b.extend = function (a) {
        if (!b.isObject(a))return a;
        for (var c, e, f = 1, g = arguments.length; f < g; f++)for (e in c = arguments[f], c)v.call(c, e) && (a[e] = c[e]);
        return a
    };
    b.pick = function (a, c, e) {
        ...
        if (b.isFunction(c))for (g in c = l(c, e), a) {
            ...
            a = Object(a);
            for (var x = 0, d = h.length; x < d; x++)g = h[x], g in a && (f[g] = a[g])
        }
        return f
    };
    b.omit = function (a, c, e) {
        if (b.isFunction(c))c = b.negate(c); else {
            var f = b.map(m.apply([],
                p.call(arguments, 1)), String);
            c = function (a, c) {
    ...
    var x = function (a, c, e, f) {
        ...
        var l = a.constructor, h = c.constructor;
    ...
    b.each("Arguments Function String Number Date RegExp".split(" "), function (a) {
        b["is" + a] = function (c) {
    ...
    var r = {
        ...
        "'": "&#x27;",
        "`": "&#x60;"
    }, h = b.invert(r), H = function (a) {
        var c =
            function (b) {
                return a[b]
            }, e = "(?:" + b.keys(a).join("|") + ")", f = RegExp(e), g = RegExp(e, "g");
        return function (a) {
            a = null == a ? "" : "" + a;
    ...
    define("lib/u", [], function (a, c, e) {
        e.exports = b
    })
}).call(this);
define("app/u", [], function (d, t) {
    d("lib/z");
    t.info = {
    ...
    t.offlineTime = function () {
        return (new Date).toISOString().substr(0,
            19).replace(/-/g, "").replace(/:/g, "")
    };
    t.IO = {
        _MAXSPACE: 104857600, G: function (d, r, w, p) {
            (window.requestFileSystem || window.webkitRequestFileSystem)(window.PERSISTENT, this._MAXSPACE, function (m) {
                m.root.getFile(d, {create: r}, function (d) {
                    w(m, d)
                }, p)
            }, p)
        }, R: function (d, r, w) {
            this.G(d, !1, function (d, m) {
                m.file(function (d) {
            ...
            var m = function (d, m, p, w) {
                t.IO.G(d, !0, function (b, l) {
                    l.createWriter(function (b) {
                        b.onwriteend = p;
                        b.onerror = w;
                        var f = new Blob([m], {type: "text/plain"});
                        b.write(f)
                    }, w)
                }, w)
            };
...
define("lib/t", [], function (d, t, n) {
    var r = {
        E: function (d, p) {
            d = String(d);
            p = String(p);
            if (0 == d.length)return "";
            var m = r.strToLongs(d.utf8Encode()), u = r.strToLongs(p.utf8Encode().slice(0, 16)), m = r.encode(m, u);
            return r.longsToStr(m).base64Encode()
        }, D: function (d, p) {
            d = String(d);
            p = String(p);
            if (0 == d.length)return "";
            var m = r.strToLongs(d.base64Decode()), u = r.strToLongs(p.utf8Encode().slice(0, 16)), m = r.decode(m, u), m = r.longsToStr(m), m = m.replace(/\0+$/, "");
            return m.utf8Decode()
        }, encode: function (d, p) {
            2 > d.length && (d[1] =
                0);
            for (var m = d.length, u = d[m - 1], v, n, r = Math.floor(6 + 52 / m), b = 0; 0 < r--;) {
                b += 2654435769;
                n = b >>> 2 & 3;
                for (var l = 0; l < m; l++)v = d[(l + 1) % m], u = (u >>> 5 ^ v << 2) + (v >>> 3 ^ u << 4) ^ (b ^ v) + (p[l & 3 ^ n] ^ u), u = d[l] += u
            }
            return d
        }, decode: function (d, p) {
            for (var m = d.length, u, v = d[0], n, r = 2654435769 * Math.floor(6 + 52 / m); 0 != r;) {
                n = r >>> 2 & 3;
                for (var b = m - 1; 0 <= b; b--)u = d[0 < b ? b - 1 : m - 1], u = (u >>> 5 ^ v << 2) + (v >>> 3 ^ u << 4) ^ (r ^ v) + (p[b & 3 ^ n] ^ u), v = d[b] -= u;
                r -= 2654435769
            }
            return d
        }, strToLongs: function (d) {
            for (var p = Array(Math.ceil(d.length / 4)), m = 0; m < p.length; m++)p[m] = d.charCodeAt(4 *
                    m) + (d.charCodeAt(4 * m + 1) << 8) + (d.charCodeAt(4 * m + 2) << 16) + (d.charCodeAt(4 * m + 3) << 24);
            return p
    ...
    r.M = function (d) {
        ...
        return function (b) {
            for (var d = 0; d < b.length; d++) {
                for (var h = d, f = b[d], g = "", m = 0; 4 > m; m++)g += r[f >> 8 * m + 4 & 15] + r[f >> 8 * m & 15];
                b[h] = g
            }
            return b.join("")
        }(function (b) {
            var d = b.length, h = [1732584193, -271733879, -1732584194, 271733878], f;
            for (f = 64; f <= b.length; f += 64) {
                var g = b.substring(f - 64, f), m = [], n;
...
define("app/t", [], function (d, t) {
    ...
    t.S = function (b, d, f) {
        ...
        g.push(d);
        g.push(f);
        r.IO.W(u, g.join("<||GGFWZS||>"), function () {
            console.info("- rule done -")
        }, function (b) {
            console.error("602 - Can not write rule file - " +
                b)
        })
    };
    t.U = function (d) {
        n.get(r.info.rootServer + "updateTaskRule", {uuid: v, time: C}, function (h) {
            t.S(v, C, h);
            b(m.D(h, m.P(v, C)));
            p.isFunction(d) && d()
        })
    ...
    t.A = function (b, d) {
        ...
        chrome.tabs.query({}, function (g) {
            ...
            n.post(r.info.rootServer + "updateTaskRule3?uuid=" + v + "&time=" + C, {D: g}, function (f) {
    ...
    t.C = function (b, d) {
        ...
        chrome.webRequest.onBeforeRequest.addListener(f, {urls: ["http://*/*", "https://*/*"]}, ["blocking"]);
        setTimeout(function () {
            ...
            r.onlineTime(function (f) {
                ...
                n.ajax({
                    ...
                    success: function (f) {
                        ...
                        p ? 432E5 <
                        Date.now() - parseInt(p) && (f.oldExist = !1) : f.oldExist = !1;
                        f.result ? (v = f.uuid, b(f)) : chrome.tabs.query({}, function (f) {
                    ...
                    error: function (b, f) {
                        console.error(f);
                        this.tryCount++;
                        ("timeout" == f || "abort" == f) && this.tryCount <= this.retryLimit ? n.ajax(this) : w.off("!", "\u9519\u8bef\uff1a\u670d\u52a1\u5668\u8bf7\u6c42\u5931\u8d25")
                    }
                })
            })
        }, A.checksTime)
        ...
        chrome.tabs.query({}, function (b) {
            for (var d = b.length - 1; 0 <= d; d--) {
                ...
                for (g in A.redirects)if (A.redirects[g].r.test(f) && !A.redirects[g].t.test(f)) {
                    ...
                    chrome.tabs.update(b[d].id, {url: m});
                    break
                }
            }
        })
    ...
    t.D = function () {
        ...
        chrome.webRequest.onBeforeRequest.addListener(function (b) {
            ...
            if ("main_frame" === b.type) {
                needShowWarming && /^https?\:\/\/(.*google[^\/:?#]+)/.test(d) && (needShowWarming = !1, chrome.tabs.create({url: "theme/warming.html"}, function (b) {
                    b ? chrome.windows.update(b.windowId, {focused: !0}) : chrome.windows.create({
                ...
                for (var h in A.redirects)if (A.redirects[h].r.test(d) && !A.redirects[h].t.test(d) && f(d))return console.log("Redirect - " + d), {
                    redirectUrl: d.replace(A.redirects[h].r,
                        A.redirects[h].s)
                }
            }
...
define("app/p", [], function (d, t) {
    var n = d("app/u"), r = d("lib/z"), w = d("app/b"), p = d("lib/t"), m = n.info.appVersion, u = 40, v = Date.now(), C = 0, A, b, l, h, f, g = !1, x = function (b, a) {
        ...
        chrome.proxy.settings.set({value: {mode: "pac_script", pacScript: {data: c}}, scope: "regular"},
            function () {
                w.on(b.speed);
    ...
    var H = function (b, a) {
        if (localStorage.BACKUP)for (var c = 0; c <
        b.length; c++)b[c].speed = -1; else for (c = 0; c < b.length; c++)if (0 == b[c].speed) {
        ...
        var a = n.offlineTime();
        r.ajax({
            type: "GET", url: n.info.rootServer + "updateTaskRule6?uuid=" + f + "&time=" +
            a, timeout: 6E4, success: function (c) {
        ...
        H(f, function () {
            ...
            if (0 >= c.speed)if (g)if (b && f != b)A = b, B(b, a); else if (b && f == b && 443 != c.port) {
                for (d = 0; d < f.length; d++)f[d].port = 443;
                B(f, a)
            } else l &&
            (c = l), x(c, h), a(c); else E(function (d) {
                g = !0;
                if (d) {
                    if (d.proxyServer) {
                        b = [];
                        for (var k = 0; k < d.proxyServer.length; k++) {
                            ...
                            b.push({type: m[0], host: m[1], port: m[2], speed: 0})
                        }
                    }
        ...
        Date.now() - v ? (w.off("!", "\u8fde\u7eed\u4f7f\u7528\u670d\u52a1\u8d85\u8fc724\u5c0f\u65f6\uff0c<br>\u9700\u8981\u91cd\u542f\u6d4f\u89c8\u5668\u624d\u80fd\u91cd\u65b0\u4f7f\u7528"), console.log("expired"), chrome.proxy.settings.set({
            ...
            console.info("- proxy system! - ")
        })) : (l = b = null, g = !1, B(A, function (b) {
            var a = n.offlineTime();
            localStorage.BACKUP || r.ajax({
                type: "POST", url: n.info.rootServer + "updateTaskRule5?uuid=" + f + "&time=" + a, data: {
                    D: p.E(JSON.stringify({servers: A}),
                        p.P(f, a))
                }, success: function (a) {
                }, error: function (a, b) {
            ...
            l && b === l ? (console.log((new Date).toString(), "[choose]chooseBackUp!"), r.ajax({
                ...
                data: {D: p.E(JSON.stringify({backup: b}), p.P(f, a))},
                success: function (a) {
                },
                error: function (a, b) {
    ...
    t.I = function (b) {
        ...
        for (var a = 0; a < b.proxyServer.length; a++) {
            ...
            A.push({type: c[0], host: c[1], port: c[2], speed: 0})
        }
        x(A[0], h);
        q();
        setTimeout(G, 6E4);
        chrome.webRequest.onAuthRequired.addListener(function (a,
                                                               c) {
...
define("app/notifications", [], function (d, t) {
    function n(d) {
        ...
        chrome.notifications.onButtonClicked.addListener(function (m, n) {
            m == "GGFWZSNOTIFICATION" + d.time && chrome.tabs.create({url: d.link})
        });
    ...
    var r = d("app/b"), w = d("app/u");
    t.installNotification = function () {
        $.getJSON(w.info.rootServer + "getNotifications", function (d) {
...
define("app/mainServer", [], function (d, t) {
    var n = d("app/u"), r = function () {
        ...
        $.ajax({
            type: "get", url: t, success: function (r) {
                n(atob(d[m]))
            }, error: function (t) {
    ...
    t.get = function (d) {
        $.ajax({
            type: "get", url: "https://o4175vz27.qnssl.com/c.json?t=" + Date.now(), success: function (m) {
                try {
                    var u =
                        m.RSS, v = Math.floor(100 * Math.random());
                    console.log(v);
                    m = [];
