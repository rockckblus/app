module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            build: {
                files: ['Gruntfile.js', '../dipan.so/index.html','js/app/src/**/*.js','js/app/src/**/**/*.js', 'js/app/src/**/**/**/*.js','css/src/*.css','html/src/**/**/**/*.html','html/src/**/**/html','html/src/**/*.html'],
        ...
        concat: {
            ...
            dist: {
                ...
                dest: '../dipan.so/js/dist/app.js'//合并文件在dist下名为app.js的文件
            }
        },
        ...
        uglify: {
            hellosea: {
                files: {
                    '../dipan.so/js/dist/app.js': ['../dipan.so/js/dist/app.js']
                }
            }
        },
...
//            js: ['js/app/dist/app.templates.js'],
        ...
        cssmin: {
            ...
            target2: {
                files: {
                    '../dipan.so/css/dist/app.css': ['css/dist/*.min.css']
                }
            }
        }
