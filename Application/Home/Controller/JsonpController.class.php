...
{
    /**百度下拉api http://api.map.baidu.com/place/v2/suggestion?query=天安门=全国（天津市）&output=json&ak=E4805d16520de693a3fe707cdc962045 //返回一组包含"天安门"字段的建议词条列表*/
    ...
    /**返回全国城市数组*/
        function getAllCity(){
            ...
            foreach($pinYinArr as $v1){
                $where['pinyin'] = $v1;
                $pinArr[$v1] = $data->where($where)->select();
                $pinArr[$v1]['header'] = $v1;
            }
